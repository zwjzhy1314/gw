 ...
 */
document.writeln("<header class=\'am-topbar header\'>");
document.writeln("    <div class=\'am-container-1\'>");
document.writeln("        <div class=\'left mi-logo\'>");
document.writeln("            <img class=\' logo\' src=\'resource/img/MIXIAOTU.png\'/>");
//document.writeln("            <img class=\'word\' src=\'img/mi-word.png\'/>");
document.writeln("            <div class=\'mi-title\'>科学芈盒儿童创客中心</div>");
...
document.writeln("                class=\'am-icon-bars\'></span>");
document.writeln("        </button>");
document.writeln("");
document.writeln("        <div class=\'am-collapse am-topbar-collapse right\' id=\'doc-topbar-collapse\'>");
document.writeln("            <div class=\' am-topbar-left am-form-inline am-topbar-right\' role=\'search\'>");
document.writeln("                <ul class=\'am-nav am-nav-pills am-topbar-nav mi-menu\'>");
document.writeln("                    <li style=\'display: none\'>");
document.writeln("                        <div class=\'am-dropdown\' data-am-dropdown>");
document.writeln("                            <button class=\'am-btn am-btn-success am-dropdown-toggle\'>微信 <span");
document.writeln("                                    class=\'am-icon-caret-down\'></span></button>");
document.writeln("                            <div class=\'am-dropdown-content\'>");
document.writeln("                                <h2>微信公众号</h2>");
document.writeln("                                <img src=\'img/erweima.png\'/>");
document.writeln("                            </div>");
document.writeln("                        </div>");
document.writeln("                    </li>");
document.writeln("                    <li id=\'nav01\'><a href=\'index.html\'>首页</a></li>");
document.writeln("                    <li id=\'nav02\'><a href=\'brand.html\'>品牌故事</a></li>");
document.writeln("                    <li id=\'nav03\'><a href=\'lesson.html\'>课程体系</a></li>");
document.writeln("                    <li id=\'nav04\'><a href=\'news.html\'>新闻动态</a></li>");
document.writeln("                    <li id=\'nav05\'><a href=\'cooperat.html\'>合作共赢</a></li>");
document.writeln("                    <li id=\'nav06\'><a href=\'about-us.html\'>联系我们</a></li>");
document.writeln("                </ul>");
document.writeln("            </div>");
document.writeln("        </div>");
document.writeln("    </div>");
