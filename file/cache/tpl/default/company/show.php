...
<div class="m_l f_l">
<div class="left_box">
<div class="pos">当前位置: <a href="<?php echo $MODULE['1']['linkurl'];?>">首页</a> &raquo; <a href="<?php echo $MOD['linkurl'];?>"><?php echo $MOD['name'];?></a> &raquo; <?php echo $member['company'];?></div>
...
<?php if($member['vip']) { ?>
<li class="f_orange" style="padding:5px 0 0 12px;"><img src="<?php echo DT_SKIN;?>image/vip_<?php echo $member['vip'];?>.gif" alt="<?php echo VIP;?>" title="<?php echo VIP;?>:<?php echo $member['vip'];?>级"/> [第<?php echo vip_year($member['fromtime']);?>年] 指数:<?php echo $member['vip'];?></li>
<?php } ?>
...
<?php if($member['validated']) { ?>&nbsp;<img src="<?php echo DT_STATIC;?>file/image/check-ok.png" align="absmiddle"/> 企业资料通过<?php echo $member['validator'];?>认证<?php } ?>
</li>
<?php } ?>
<li style="padding-top:6px;padding-bottom:6px;">
<span>联系人</span><?php echo $member['truename'];?>(<?php echo gender($member['gender']);?>)&nbsp;<?php echo $member['career'];?>&nbsp;
<?php if($member['username'] && $DT['im_web']) { ?><?php echo im_web($member['username']);?>&nbsp;<?php } ?>
