...
<tr>
<td class="tl">开户银行</td>
<td class="tr"><?php if($user['bank']) { ?><?php echo $user['bank'];?><?php } else { ?>未设置<?php } ?></td>
</tr> 
<tr>
<td class="tl">开户网点</td>
<td class="tr"><?php if($user['branch']) { ?><?php echo $user['branch'];?><?php } else { ?>未设置<?php } ?></td>
</tr>
<tr>
<td class="tl">收款帐号</td>
<td class="tr"><?php if($user['account']) { ?><?php echo $user['account'];?><?php } else { ?>未设置<?php } ?></td>
</tr>
<tr>
<td class="tl">收款户名</td>
<td class="tr"><?php if($user['banktype']) { ?><?php echo $user['company'];?><?php } else { ?><?php echo $user['truename'];?><?php } ?></td>
</tr>
<?php if($user['vbank']) { ?>
<tr>
<td class="tl">认证状态</td>
...
<?php if($MOD['vemail']) { ?>
<a href="?action=email" class="t">邮件认证</a> &nbsp; <?php if($vemail) { ?><span class="f_green">已通过</span><?php } else { ?><span class="f_gray">未通过</span><?php } ?><br/>
<?php } ?>
<?php if($MOD['vmobile']) { ?>
<a href="?action=mobile" class="t">手机认证</a> &nbsp; <?php if($vmobile) { ?><span class="f_green">已通过</span><?php } else { ?><span class="f_gray">未通过</span><?php } ?><br/>
<?php } ?>
<?php if($MOD['vbank']) { ?>
<a href="?action=bank" class="t">银行认证</a> &nbsp; <?php if($vbank) { ?><span class="f_green">已通过</span><?php } else { ?><span class="f_gray">未通过</span><?php } ?><br/>
<?php } ?>
<?php if($MOD['vtruename']) { ?>
<a href="?action=truename" class="t">实名认证</a> &nbsp; <?php if($vtruename) { ?><span class="f_green">已通过</span><?php } else { ?><span class="f_gray">未通过</span><?php } ?><br/>
<?php } ?>
<?php if($MOD['vcompany'] && $MG['type']) { ?>
<a href="?action=company" class="t">公司认证</a> &nbsp; <?php if($vcompany) { ?><span class="f_green">已通过</span><?php } else { ?><span class="f_gray">未通过</span><?php } ?><br/>
<?php } ?>
</div>
</td>
</tr>
