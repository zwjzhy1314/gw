...
<a href="<?php if($t['linkurl']) { ?><?php echo $t['linkurl'];?><?php } else { ?>###<?php } ?>" target="<?php if($t['linkurl']) { ?>_blank<?php } else { ?>_self<?php } ?>"><img src="<?php echo $t['thumb'];?>" width="<?php echo $width;?>" height="<?php echo $height;?>" alt="<?php echo $t['alt'];?>"/></a>
<?php } } ?>
</div>
