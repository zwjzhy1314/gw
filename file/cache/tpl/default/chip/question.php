<?php defined('IN_DESTOON') or exit('Access Denied');?><span onmouseover="if(Dd('question').style.display=='none') reloadquestion();"><span id="question" style="display:none;"><span id="questionstr"></span>&nbsp;&nbsp;<a href="javascript:reloadquestion();">[换个问题]</a><br/></span>
...
function(data) {
if(data == '0') {
Dd('canswer').innerHTML = '&nbsp;&nbsp;<img src="<?php echo DT_STATIC;?>file/image/check-ok.png" align="absmiddle"/>';
<?php if($DT_MOB['os'] == 'ios') { ?>
Dd('answer').value = s;
<?php } ?>
} else {
Dd('answer').focus;
Dd('canswer').innerHTML = '&nbsp;&nbsp;<img src="<?php echo DT_STATIC;?>file/image/check-ko.png" align="absmiddle"/>';
}
}
);
}
