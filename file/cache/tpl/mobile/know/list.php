...
<ul>
<li<?php if($typeid==0) { ?> class="on"<?php } ?>><a href="<?php echo $MOD['mobile'];?>list.php?catid=<?php echo $catid;?>&typeid=0" data-transition="flip"><span>全部问题</span></a></li>
<li<?php if($typeid==1) { ?> class="on"<?php } ?>><a href="<?php echo $MOD['mobile'];?>list.php?catid=<?php echo $catid;?>&typeid=1" data-transition="flip"><span>等待解决</span></a></li>
<li<?php if($typeid==2) { ?> class="on"<?php } ?>><a href="<?php echo $MOD['mobile'];?>list.php?catid=<?php echo $catid;?>&typeid=2" data-transition="flip"><span>已经解决</span></a></li>
</ul>
</div>
<?php if($lists) { ?>
