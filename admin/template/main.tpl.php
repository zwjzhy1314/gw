...
<tr>
<td class="tl">程序信息</td>
<td>&nbsp;DESTOON B2B Version <?php echo DT_VERSION;?> Release <?php echo DT_RELEASE;?> <?php echo DT_CHARSET;?> <?php echo strtoupper(DT_LANG);?></td>
</tr>
<tr>
<td class="tl">软件版本</td>
<?php if($edition == '&#20010;&#20154;&#29256;') { ?>
...
<?php } else { ?>
<td id="destoon_edition">&nbsp;<span class="f_blue">商业<?php echo $edition;?></span></td>
<?php } ?>
</tr>
<tr>
<td class="tl">安装时间</td>
