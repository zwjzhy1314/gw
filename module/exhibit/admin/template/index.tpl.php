...
<input type="checkbox" name="sign" value="1"<?php echo $sign ? ' checked' : '';?>/> 报名&nbsp;
</td>
</tr>
</table>
</form>
...
<?php } ?>
<td class="px12"><a href="javascript:Dwidget('?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&file=sign&id=<?php echo $v['itemid'];?>', '[<?php echo $v['alt'];?>] 报名管理');"><?php echo $v['orders'];?></a></td>
