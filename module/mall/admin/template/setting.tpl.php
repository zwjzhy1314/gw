...
<tr>
<td class="tl">订单需要卖家确认</td>
<td>
<input type="radio" name="setting[checkorder]" value="1" <?php if($checkorder==1) echo 'checked';?>/> 开启&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[checkorder]" value="0" <?php if($checkorder==0) echo 'checked';?>/> 关闭
</td>
</tr>
