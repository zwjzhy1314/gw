...
<tr>
<td class="tl"><span class="f_hid">*</span> 分类缩略图</td>
<td><input name="category[thumb]" id="thumb" type="text" size="60" value=""/>&nbsp;&nbsp;<span onclick="Dthumb(<?php echo $moduleid;?>,Dd('level').value==2 ? 330 : <?php echo $MOD['thumb_width'];?>,Dd('level').value==2 ? 250 : <?php echo $MOD['thumb_height'];?>, Dd('thumb').value);" class="jt">[上传]</span>&nbsp;&nbsp;<span onclick="_preview(Dd('thumb').value);" class="jt">[预览]</span>&nbsp;&nbsp;<span onclick="Dd('thumb').value='';" class="jt">[删除]</span></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> Price(分类价格)</td>
<td><input name="category[price]" type="text" id="price" value="" size="61"></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> Range(适龄范围)</td>
<td><input name="category[ranges]" type="text" id="ranges" value="" size="61"></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> Meta Keywords<br/>&nbsp; (关键词/标签)</td>
<td><textarea name="category[seo_keywords]" cols="60" rows="3" id="seo_keywords"></textarea></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> Meta Description<br/>&nbsp; (摘要/描述)</td>
