...
<td><input name="category[price]" type="text" id="price" value="<?php echo $price;?>" size="61"></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> Range(适龄范围)</td>
<td><input name="category[ranges]" type="text" id="ranges" value="<?php echo $ranges;?>" size="61"></td>
</tr>
<tr>
